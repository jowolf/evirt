...
class ServerProxy(XMLServerProxy):
    ...
    def __init__(self, uri, transport=None, encoding=None, 
        ...
        if transport is None:
            ...
            #else:
                transport = Transport()
                transport.scheme = schema  # 'scheme', not schema! schema is for databases - JJW
