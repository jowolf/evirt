...
pwd >> 11_SETUP_GIT_REPO_AND_VOLUMES
ls -l ~/volumes >> 11_SETUP_GIT_REPO_AND_VOLUMES

#mkdir -p ./volumes/app/mattermost/{data,logs,config,plugins}
sudo mkdir -p ~/volumes/app/mattermost/data
sudo mkdir -p ~/volumes/app/mattermost/logs
sudo mkdir -p ~/volumes/app/mattermost/config
sudo mkdir -p ~/volumes/app/mattermost/plugins
sudo mkdir -p ~/volumes/db/var/lib/postgresql/data
sudo mkdir -p ~/volumes/web/cert
