...
class SecureTransport (jsonrpclib.Transport):
    ...
    def send_content (self, connection, request_body):
        connection.putheader("X-evirt-Auth-Token", tok)
        jsonrpclib.Transport.send_content (self, connection, request_body)
...
if __name__ == "__main__":
    ...
    for host, shared_secret in hosts:
        try:
            ...
            tok = server.get_auth_token (hashlib.sha224 (`shared_secret`).hexdigest())
            print tok
